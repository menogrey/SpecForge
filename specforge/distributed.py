...
if _DEVICE_TYPE == "npu":
    ...
    _orig_new_group_with_tag = _dc10d._new_group_with_tag

    def _patched_new_group_with_tag(
        ...
        return _orig_new_group_with_tag(
            ...
            group_desc=group_desc, device_id=device_id,
        )

    _dc10d._new_group_with_tag = _patched_new_group_with_tag
...
def init_distributed(
    ...
    """
    backend = "hccl" if _DEVICE_TYPE == "npu" else "nccl"
    ...
    local_rank = dist.get_rank() % device_module.device_count()
    ...
    device_mesh = dist.device_mesh.init_device_mesh(
        _DEVICE_TYPE, (dp_size, tp_size), mesh_dim_names=("dp", "tp")
    )
    ...
    tp_device_mesh = dist.DeviceMesh.from_group(tp_group, device_type=_DEVICE_TYPE)
    ...
    _DP_DEVICE_MESH = dist.DeviceMesh.from_group(dp_group, device_type=_DEVICE_TYPE)
